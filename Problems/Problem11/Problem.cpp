...
Problem11::Problem11()
{
    this->ProblemName = new std::string("Largest product in a grid");
    this->ProblemNumber = 11;
}

void Problem11::Execute()
{
    uint32_t product, highestProduct = 0;
    ...
    this->answer = highestProduct;
}

void Problem11::GetAnswer()
{
    printf("Answer: %u\r\n", this->answer);
}

void Problem11::GetInputs()
{
